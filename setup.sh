...
document.getElementById('closeModal').onclick=function(){
    ...
    def get_instagram_story_custom(u,v,p,vt,vi,l,c):
        return "<html><body><h1>Instagram Story</h1><p>@"+u+"</p></body></html>"
    
    @staticmethod
    def get_tiktok_video_custom(u,v,p,vt,vi,l,c,sh,ca):
        return "<html><body><h1>TikTok Video</h1><p>@"+u+"</p></body></html>"
    
    @staticmethod
    def get_instagram_camera(u,v,p,vt,l,c,sh,ca):
        return "<html><body><h1>Instagram Reel</h1><p>@"+u+"</p></body></html>"
    
    @staticmethod
    def get_tiktok_camera(u,v,p,vt,l,c,sh,ca):
        return "<html><body><h1>TikTok Camera</h1><p>@"+u+"</p></body></html>"
EOF
